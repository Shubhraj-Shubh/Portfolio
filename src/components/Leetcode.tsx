        ...
        <div className="container mx-auto max-w-6xl px-8">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-full h-[18rem] md:h-[25rem] overflow-hidden">
              <img
                src="https://leetcard.jacoblin.cool/Shubhraj-?theme=dark&font=Inter&ext=activity&border=2&radius=10"
            ...
            <div>
              ...
              <p className=" text-center text-lg text-gray-600 dark:text-gray-300 mb-4">
                Started solving LeetCode problems to get better at DSA and honestly, it's become a daily habit now. Some days I breeze through easy/medium problems, other days hard problems make me question my life choices 😅
              </p>
              <p className=" text-center text-lg text-gray-600 dark:text-gray-300">
                I've tackled problems across arrays, trees, graphs, and that scary beast called multidimensional DP. The goal? Stay consistent, learn something new every day, and maybe not panic during technical interviews!
              </p>

              {/* LeetCode Profile Button */}
              <div className="mt-6 flex justify-center">
                <a
                  href="https://leetcode.com/u/Shubhraj-/"
                  target="_blank"
