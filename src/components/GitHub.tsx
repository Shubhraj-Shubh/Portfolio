...
export function GitHub() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/users/Shubhraj-Shubh")
      .then((response) => response.json())
      .then((data: UserProfile) => setUser(data));

    fetch("https://api.github.com/users/Shubhraj-Shubh/repos?sort=pushed&direction=desc&per_page=3")
      .then((response) => response.json())
      .then((data) =>
        setRepos(
          data.map((repo: any) => ({
    ...
    <SectionBackground>
      <section id="github">
        <div className="container mx-auto max-w-6xl px-8">
          <SectionTitle subtitle="My GitHub is where I code and commit - check out my repos I'm proud of">GitHub Contributions</SectionTitle>
