...
const roles = [
  ...
  "Night Canteen Regular",       
  "Hostel WiFi Debugger",          
  "Assignment Deadline Sprinter",  
  "IIT KGP Mess Food Survivor",    
  "Sleepless Debugging Ninja",     
  "Campus Marathon Walker"       
];
      ...
      <div className="container mx-auto px-10 py-16 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative order-1 md:order-2">
            ...
            <img
              src="/assets/Shubhraj-photo.jpg"
              alt="Shubhraj Singh Dodiya"
