            ...
            <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span>linkedin.com/in/shubhraj-shubh</span>
                </a>
              </div>
            </div>
